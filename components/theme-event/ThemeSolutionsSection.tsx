...
const services = [
  {
    ...
    images: [
      "/assets/static/Images/Theme Events/Wedding Themed Events and Design/img1.jpg",
      "/assets/static/Images/Theme Events/Wedding Themed Events and Design/img2.jpg",
      "/assets/static/Images/Theme Events/Wedding Themed Events and Design/img3.jpg",
    ],
  },
  {
    number: "02",
    ...
    images: [
      "/assets/static/Images/Theme Events/Floral Decoration/img1.jpg",
      "/assets/static/Images/Theme Events/Floral Decoration/img2.jpg",
      "/assets/static/Images/Theme Events/Floral Decoration/img3.jpg",
    ],
  },
  {
    number: "03",
    ...
    images: [
      "/assets/static/Images/Theme Events/Festival/img1.jpg",
      "/assets/static/Images/Theme Events/Festival/img2.jpg",
      "/assets/static/Images/Theme Events/Festival/img3.jpg",
    ],
  },
  {
    number: "04",
    ...
    images: [
      "/assets/static/Images/Theme Events/College Events & Stalls/img1.jpg",
      "/assets/static/Images/Theme Events/College Events & Stalls/img2.jpg",
      "/assets/static/Images/Theme Events/College Events & Stalls/img3.jpg",
    ],
  },
];
              ...
              <div className="max-w-5xl mx-auto">
                <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
                  <div className="flex-shrink-0">
                    <span className="text-6xl md:text-7xl font-bold text-ylow800 text-500/30">
                      {service.number}
                    </span>
                  </div>
