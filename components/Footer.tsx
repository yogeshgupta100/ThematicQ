        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-16">
          <div className="flex flex-col items-start gap-4 max-w-md">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              At ThematicQ, each event is an opportunity to narrate a unique
              story. We combine ideas, people, and brands to craft memorable,
              inspiring, and connective experiences.
            </p>
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex flex-col gap-3 text-sm text-gray-700">
              ...
              >
                ...
                <span>8178575159</span>
              </a>

              <a
                href="tel:+919355333343"
                className="flex items-center gap-3 hover:text-[#EBB964] transition-colors"
              >
                <svg
                  className="w-5 h-5"
              ...
              <div className="flex items-start gap-3">
                ...
                <span>A-4 Top floor Dwarka Sec 19 110075</span>
              </div>
