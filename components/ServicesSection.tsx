        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start mt-8">
          <div className="space-y-8">
            {services.map((service, index) => (
              <AnimatedSection
                ...
                delay={index * 100}
              >
                <div className="border-l-4 pl-6 group  transition-colors duration-300">
                  <h3 className="text-lg md:text-xl font-medium mb-3   transition-colors">
                    {service.title}
                  </h3>
          ...
          <AnimatedSection direction="left" delay={200}>
            <div className="space-y-6">
              <div className="relative w-full h-64 md:h-80 rounded-lg overflow-hidden border border-500/20 hover:border-500/50 transition-all duration-300 group">
                <Image
                  src="/assets/static/Images/Homepage/ServicesScreen/2.webp"
                  alt="Outdoor Event Setup"
                  fill
                  className="object-cover transition-transform duration-700 group-hover:scale-110"
                  sizes="(max-width: 768px) 100vw, 50vw"
                />
                <div className="absolute inset-0 bg-gradient-to-br from-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <div className="relative w-full h-64 md:h-80 rounded-lg overflow-hidden border border-500/20 hover:border-teal-500/50 transition-all duration-300 group">
                <Image
                  src="/assets/static/Images/Homepage/ServicesScreen/3.webp"
