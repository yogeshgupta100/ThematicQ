        ...
        <AnimatedSection direction="fade" delay={0}>
          ...
          >
            ...
            <div className="space-y-6 text-lg md:text-xl text-gray-300 leading-relaxed max-w-4xl">
              ...
              <p>
                The year 2020 brought unprecedented challenges, but it also
                became a turning point. We adapted, evolved, and reimagined what
                event management could be. It was during this time that our
                vision crystallized into something more profound.
              </p>
              <p>
                Today, ThematicQ represents the perfect fusion of strategy,
                storytelling, and creativity. We&apos;ve transformed from
                festival organizers into event storytellers, dedicated to
                turning every moment into a memory and every gathering into an
