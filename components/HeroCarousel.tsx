...
const carouselImages: CarouselImage[] = [
  {
    ...
    title: `The <span class="text-yellow-400">Event</span><br/> StoryTellers`,
    subtitle: "Question quality quotient",
    smtitle:
      "At the end of the day, people might forget the menu, but they will never forget how your story made them feel.",
  },
  {
    id: 2,
    src: "/assets/images/carousel2.webp",
    alt: "Business growth",
    title: `We turn your <span class="text-yellow-400">What If</span><br/>into <span class="text-yellow-400">What Just Happened</span>`,
    subtitle: "",
    smtitle: "",
  },
  {
    ...
    title: `From <span class="text-yellow-400">Mice</span> to <span class="text-yellow-400">Marketing</span><br/> We got you covered.`,
    subtitle: "",
    smtitle: "",
  },
];
...
export default function HeroCarousel() {
  ...
  const { ref: heroAnimationRef, isVisible: heroVisible } =
    useScrollAnimation({
      threshold: 0.1,
    });
              ...
              {isActive && (
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    ...
                    style={{
                      transitionDelay: isTextRefreshing
                        ? "0ms"
                        : "200ms",
                    }}
                  >
        ...
        {carouselImages.map((_, index) => (
          <button
            ...
            className={`rounded-full transition-all duration-500 ${
              index === currentIndex
                ? "w-8 md:w-10 h-3 bg-white shadow-lg"
